...
namespace MKaverin\SplitwiseSDK;

use DateTimeImmutable;
use MKaverin\SplitwiseSDK\Resource\Comments;
use MKaverin\SplitwiseSDK\Resource\Expenses;
use MKaverin\SplitwiseSDK\Resource\Friends;
use MKaverin\SplitwiseSDK\Resource\Groups;
use MKaverin\SplitwiseSDK\Resource\Notifications;
use MKaverin\SplitwiseSDK\Resource\Other;
use MKaverin\SplitwiseSDK\Resource\Users;
 ...
 *
 * If something in the API is confusing you, you can open an issue about it [on GitHub](https://github.com/splitwise/api-docs).
 ...
 *   - https://github.com/athulanilthomas/splitwise-ts
 * - Ruby
 ...
 * </ol>
 */
class SplitwiseSDK extends Connector
{
    use AlwaysThrowOnErrors;

    public function __construct(
        protected readonly string $accessToken,
        protected readonly ?string $refreshToken = null,
        protected readonly ?DateTimeImmutable $expiresAt = null,
    ) {}
    ...
    {
        return new AccessTokenAuthenticator($this->accessToken, $this->refreshToken, $this->expiresAt);
    }
}
